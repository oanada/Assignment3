...
```{r, message = FALSE, echo = FALSE, out.width="100%",fig.fullwidth=TRUE, fig.align='center',fig.asp =0.35}
...
```{r include=TRUE, message=FALSE, warning=FALSE,echo = FALSE,out.width="70%",fig.fullwidth=TRUE, fig.align='center',fig.asp =0.65} 
